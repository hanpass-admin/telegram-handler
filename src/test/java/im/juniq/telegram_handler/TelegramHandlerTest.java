...
class TelegramHandlerTest {
    ...
    void 특정필드_가져오기() {
        ...
        assertThat(telegramHandler.field(6, 10)).isEqualTo("testname");
        assertThat(telegramHandler.field(16, 6)).isEqualTo("한글");
        assertThat(telegramHandler.field(16, 7)).isEqualTo("한글");
    ...
    void 특정필드_가져오기_EUCKR() {
        ...
        assertThat(telegramHandler.field(16, 5)).isEqualTo("한글");
    ...
    void 특정바이트_가져오기() {
        ...
        assertThat(new String(telegramHandler.byteField(1, 1))).isEqualTo("1");
    }
}
